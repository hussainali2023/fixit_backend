...
export type BookingOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "serviceId" | "customerId" | "technicianId" | "scheduledDate" | "totalPrice" | "status" | "createdAt" | "updatedAt", ExtArgs["result"]["booking"]>;
